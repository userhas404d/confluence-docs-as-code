...
export function buildDiscussionBody({
    ...
    return [
        ...
        '',
        '> **Note:** Emoji reactions are not synced. The Confluence REST API does not',
        '> expose emoji reactions on comments, only simple likes. Comment text and',
        '> resolution status are fully supported.',,
    ].join('\n');
}
